...
- 2026-04-22 · 进入自动模式推进 W1：
  - W1.1 真实素材收集清单已建 —— 等作者回填
  - W1.2 标题三候选起草完成
  - W1.3 – W1.7 稿子骨架初稿已写，4 处 ⚠️ 标注等真实素材替换
  - W1.8 骨架版 self-review 通过（9/13 项 ✅，4 项 ⚠️ 待素材替换后复查）
- 2026-04-22 · 🚨 **排期紧急前移**（用户决策："今天是周三，需要发一篇"）：
  - W1 发布日由 2026-04-29 前移到 **2026-04-22 今天**
  - W2–W5 整体前移一周：W2=2026-04-29（bixia）/ W3=2026-05-06（bazong）/ W4=2026-05-13（beyond）/ W5=2026-05-20（zhiyin 或 fuwang）
  - drafts 文件重命名：`2026-04-29-jiejie-w1.md` → `2026-04-22-jiejie-w1.md`（notes 同）
